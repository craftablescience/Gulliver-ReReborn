...
public abstract class ClassPatch {
    ...
    public MethodNode getMethodLazy(ClassNode cn, String deobf, String obf) {
        ...
        GulliverReborn.LOGGER.warn("[AstralTransformer] Find method will fail. Printing all methods as debug...");
        for (MethodNode found : cn.methods) {
            GulliverReborn.LOGGER.warn("Method: mame=" + found.name + ", desc=" + found.desc + ", signature=" + found.signature);
        }
